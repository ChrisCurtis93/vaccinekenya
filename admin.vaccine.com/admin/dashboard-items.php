				  ...
				  <div class="row">
                        <div class="col-lg-3 col-md-6 col-sm-6">
                            <div class="card card-stats">
                                ...
                                <div class="card-content">
                                    <p class="category">Filed Claims</p>
                                    <h3 class="card-title">184</h3>
                                </div>
                                <div class="card-footer">
                                    <div class="stats">
                                        <i class="material-icons text-danger">warning</i>
                                        <a href="#pablo">active users</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-6 col-sm-6">
                            <div class="card card-stats">
                                ...
                                <div class="card-footer">
                                    <div class="stats">
                                        <i class="material-icons">local_offer</i> active users
                                    </div>
                                </div>
                            </div>
                        </div>
          ...
          <!--           <div class="row">
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="card-content">
                                    <h4 class="card-title">Regional Registered Building</h4>
                                    <div class="row">
                                        <div class="col-md-5">
                                                ...
                                                <table class="table">
                                                    <tbody>
                                                        <tr>
                                                            <td>
                                                                <div class="flag">
                                                                    <img src="assets/img/flags/kenya.png">
                                                                </div>
                                                            </td>
                                                            <td>Kenya</td>
                                                            <td class="text-right">
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <div class="flag">
                                                                    <img src="assets/img/flags/uganda.png">
                                                                </div>
                                                            </td>
                                                            <td>Uganda</td>
                                                            <td class="text-right">
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <div class="flag">
                                                                    <img src="assets/img/flags/tz.png">
                                                                </div>
                                                            </td>
                                                            <td>Tanzania</td>
                                                            <td class="text-right">
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <div class="flag">
                                                                    <img src="assets/img/flags/rwanda.png">
                                                                </div>
                                                            </td>
                                                            <td>Rwanda</td>
                                                            <td class="text-right">
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <div class="flag">
                                                                    <img src="assets/img/flags/sudan.png">
                                                                </div>
                                                            </td>
                                                            <td>Sudan</td>
                                                            <td class="text-right">
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <div class="flag">
                                                                    <img src="assets/img/flags/ghana.png">
                                                                </div>
                                                            </td>
                                                            <td>Ghana</td>
                                                            <td class="text-right">
                        ...
                        <div class="col-md-4">
                            <div class="card card-chart">
                                ...
                                <div class="card-content">
                                    ...
                                    <h4 class="card-title">Daily Filed Claims</h4>
                                    <p class="category">
                        ...
                        <div class="col-md-4">
                            <div class="card card-chart">
                                ...
                                <div class="card-content">
                                    ...
                                    <h4 class="card-title">Processed Claims</h4>
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="card card-product">
                                ...
                                <div class="card-content">
                                    ...
                                    <h4 class="card-title">
                                        <a href="#pablo">INSURANCE FEEDABCKS</a>
                                    </h4>
                        ...
                        <div class="col-md-4">
                            <div class="card card-product">
                                ...
                                <div class="card-content">
                                    ...
                                    <h4 class="card-title">
                                        <a href="#pablo">CUSTOMER FEEDBACK</a>
                                    </h4>
                                    <div class="card-description">
                        ...
                        <div class="col-md-4">
                            <div class="card card-product">
                                <div class="card-image" data-header-animation="true">
                                    <a href="#pablo">
                                        <img class="img" src="assets/img/developer.jpg">
                                    </a>
                                </div>
                                <div class="card-content">
                                    <div class="card-actions">
                                    ...
                                    <h4 class="card-title">
                                        <a href="#pablo">DEVELOPER FEEDBACK</a>
                                    </h4>
                                    <div class="card-description">
            ...
            <footer class="footer">
                <div class="container-fluid">
                    ...
                    <p class="copyright pull-right">
                      ...
                      managed by  <a href=""> AT4 DEVELOPERS LIMITED</a>
                    </p>
                </div>
            </footer>
        </div>
